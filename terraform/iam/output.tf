output "network_manage_user_access_key" {
  value = "${aws_iam_access_key.networkManageUser.id}"
}
output "network_manage_user_secret_key" {
  value = "${aws_iam_access_key.networkManageUser.secret}"
}
